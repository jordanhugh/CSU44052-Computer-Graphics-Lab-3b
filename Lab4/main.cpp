...
void GenerateObjectBufferMesh()
{
	...
	//	glBindBuffer (GL_ARRAY_BUFFER, vt_vbo);
	//	glVertexAttribPointer (loc3, 2, GLF_FLOAT, GL_FALSE, 0, NULL);
}
...
void Display() 
{
	...
	modelChild = glm::rotate(modelChild, glm::radians(180.0f), glm::vec3(0.0f, 0.0f, 1.0f));
	modelChild = glm::rotate(modelChild, glm::radians(rotate_y), glm::vec3(0.0f, 1.0f, 0.0f));
